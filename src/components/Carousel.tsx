  ...
  return (
    <Box sx={{ height:325, maxWidth: "100%", margin: "0 auto", flexGrow: 1 }}>
      ...
      <Box sx={{ display: 'flex', gap:3,   }}>
        <Button size="small" className="right" onClick={handleBack} disabled={activeStep === 0}>
          {theme.direction === "rtl" ? <KeyboardArrowRight /> : <KeyboardArrowLeft />}
        </Button>
        <Button size="small" className="left" onClick={handleNext} disabled={activeStep === maxSteps - 1}>
